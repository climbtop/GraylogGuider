...
public class ProdConfig implements AbstractConfig{
	...
	private static Map<String,String> streamName2StreamIdMap = new HashMap<String,String>(){{
		put("01-OMS_Hybris_PROD","5d3b8997df33da000d11c5da");
		put("02-MALL_PROD","5d3bba6cdf33da000d11fb72");
		put("03-OMS_Promotion_PROD","5d23febedf33da000df84342");
		put("04-OMS_Sourcing_PROD","5d243306df33da000df87c25");
		put("05-OMS_Inventory_PROD","5d2430a1df33da000df87980");
		put("06-OMS_Hap_PROD","5d3b8fe6df33da000d11ccdd");
	}};
	
	private static Map<String,String[]> stream2sourceListMap = new HashMap<String,String[]>(){{
		put("01-OMS_Hybris_PROD", new String[] {"10.12.152.49 | web1", "10.12.152.50 | web2", "10.12.152.51 | intf1", "10.12.152.52 | intf2", "10.12.152.53 | job1", "10.12.152.54 | job2", "10.12.152.101 | job3", "10.12.152.117 | job4"});
		...
		put("03-OMS_Promotion_PROD", new String[] {"ECNGZVLHBRS211P","ECNGZVLHBRS212P","ECNGZVLHBRS222P"});
		put("04-OMS_Sourcing_PROD", new String[] {"ECNGZVLHBRS207P","ECNGZVLHBRS208P"});
		put("05-OMS_Inventory_PROD", new String[] {"ECNGZVLHBRS209P","ECNGZVLHBRS210P","ECNGZVLHBRS223P","ECNGZVLHBRS224P"});
		put("06-OMS_Hap_PROD", new String[] {"ECNGZVLHBRS225P.mo-co.org", "ECNGZVLHBRS226P.mo-co.org"});
	}};
